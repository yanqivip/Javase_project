...
//``````````````````````````````````````````````````````````````````````````
		if (b)
		{
			g.setColor(new Color( 80 , 180 , 80 )) ;			//��β��
...
//``````````````````````````````````````````````````````````````````````````		
		if (b)
		{
			g.setColor(new Color(80,180,80)) ;		//��ͷ
			g.fillOval( 120+x , 80+y , 60 , 100 ) ;
			g.setColor(Color.WHITE) ;
			g.fillOval( 130+x ,90+y , 10 ,10 ) ;		//����	
			g.fillOval( 160+x ,90+y , 10 ,10 ) ;		//����
			g.setColor(Color.BLACK) ;
			g.fillOval( 130+x ,90+y , 8 ,8 ) ;			//������
			g.fillOval( 160+x ,90+y , 8 ,8 ) ;			//������
		}
		else
		{
			g.setColor(new Color(80,180,80)) ;		//��ͷ
			...
			g.setColor(Color.BLACK) ;
			g.drawLine( 143+x ,83+y , 140+x , 90+y ) ;		//����
...
//``````````````````````````````````````````````````````````````````````````	
		...
		{
			g.setColor(new Color(80,180,80)) ;
			g.fillOval( 50+x ,140+y ,50 , 70 ) ;		//��צ

			g.fillOval( 200+x ,140+y ,50 , 70 ) ;		//��צ

			g.fillOval( 50+x ,280+y ,50 , 70 ) ;		//���צ

			g.fillOval( 200+x ,280+y ,50 , 70 ) ;		//�Һ�צ
		}
		else
		{	
			g.setColor(new Color(80,180,80)) ;		//��צ
			g.fillOval( 50+x ,140+y ,50 , 70 ) ;	
			g.setColor(new Color(250,100,150)) ;	//��ָͷ
			...
			g.setColor(new Color(80,180,80)) ;		//�Һ�צ
			g.fillOval( 200+x ,280+y ,50 , 70 ) ;
			g.setColor(new Color(250,100,150)) ;	//�Һ�ָͷ		
...
//```````````````````````````````````````````````````````````````````````````
		if (b)
		{
			g.setColor(new Color(50 ,160 , 50)) ;	//�����Ȧ
			g.fillOval( 60+x , 150+y , 180 ,200 ) ;		
			g.setColor(new Color(50,200,50)) ;
			g.fillOval( 70+x , 160+y , 160 ,180 ) ;		//СȦ

			g.setColor(new Color(0,0,0)) ;
			g.drawLine( 130+x , 210+y , 170+x , 210+y ) ;	//�м�Ļ���
			...
			g.drawLine( 100+x , 180+y , 130+x , 210+y ) ;	//��ɢ�����Ļ���
		...
		{
			g.setColor(new Color(80,180,80)) ;
			g.fillOval( 60+x , 150+y , 180 ,200 ) ;		//�����Ȧ
			g.setColor(new Color(255,230,240)) ;
			g.fillOval( 70+x , 160+y , 160 ,180 ) ;		//СȦ
			
			g.setColor(new Color(0,0,0)) ;			//�Ƕ��ϵĻ���
